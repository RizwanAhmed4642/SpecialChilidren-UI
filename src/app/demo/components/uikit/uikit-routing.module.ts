...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'shedule', data: { breadcrumb: 'Shedule' }, loadChildren: () => import('./shedular/shedular.module').then(m => m.ShedularComponentModule) },
        { path: 'loadData', data: { breadcrumb: 'LoadData' }, component:LoadDataComponent},
        { path: 'workerList/:id', data: { breadcrumb: 'WorkerList' }, component:WorkerListComponent},
        // { path: 'shedule', data: { breadcrumb: 'WorkerList' }, component:ShedularComponent},

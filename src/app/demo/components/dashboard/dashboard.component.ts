...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    // setTimeout(() => this.number += this.number, 5000);
  ...
  public DashBoardCountTotal = {
    TotalPatientRegistration: 0, TotalPhysicalParameters: 0, TotalDental: 0, TotalOphthalmologist: 0, TotalSpeechTherapist: 0, TotalENT: 0
